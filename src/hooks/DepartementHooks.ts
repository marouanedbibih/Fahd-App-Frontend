...
import { createDepartementAPI, deleteDepartementAPI, fetchDepartementAPI, fetchListOfDepartementsAPI, searchDepartementsAPI, updateDepartementAPI } from "@/services/DepartementService";
